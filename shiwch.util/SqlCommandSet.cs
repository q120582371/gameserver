...
namespace shiwch.util
{
    ...
    public class SqlCommandSet : IDisposable
    {
        ...
        static SqlCommandSet()
        {
            ...
            if (sqlCmdSetType == null) throw new ArgumentException("Could not find SqlCommandSet!");
        }
        ...
        {
            if (Connection == null) throw new ArgumentException("Connection was not set! You must set the connection property before calling ExecuteNonQuery()");
